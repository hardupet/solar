            ...
            {navItems.map((item, i) => (
              ...
              >
                {item.dropdownItems.length > 0 ? (
                  ...
                  <Button variant="ghost" className="text-base relative group">
                    {item.text}
                    <motion.div
                      className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-500 group-hover:w-full"
                      transition={{ duration: 0.3 }}
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          >
            <Link href="/auth/register">
              <Button className="text-base bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 shadow-md hover:shadow-xl transition-all duration-200">
                Register
              </Button>
            </Link>
          </motion.div>
